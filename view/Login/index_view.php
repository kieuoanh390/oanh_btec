            ...
            <div class="main-panel" style="min-height:100vh !important; width:100% !important;">
                ...
                <footer class="footer">
                    <div class="container-fluid d-flex justify-content-between">
                        <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © SE06205
                            2024</span>
                            <span class="float-none float-sm-end mt-1 mt-sm-0 text-end"> Copyright © <a
                                href="https://btec.fpt.edu.vn/" target="_blank">Btec</a> from FPT.com.vn</span>
                    </div>
                </footer>
