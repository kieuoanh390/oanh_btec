...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <a class="btn btn-primary" href="index.php?c=department&m=index">List Department</a>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <?php endif; ?>  
                                <br/>
                                <img width="50%" class="img-fluid" alt="<?=$info['name'];?>" src="public/uploads/images/<?=$info['logo'];?>">   
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input value="<?=$info['date_beginning'];?>" type="date" class="form-control" name="beginning_date">
                            </div>
                            <div>
